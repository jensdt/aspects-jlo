// $ANTLR 3.3 Nov 30, 2010 12:45:30 JavaL.g 2011-05-19 23:04:45
...
public class Java_JavaL extends Lexer {
    ...
    public final void mLetter() throws RecognitionException {
        try {
            // JavaL.g:79:5: ( '\\u0024' | '\\u0041' .. '\\u005a' | '\\u005f' | '\\u0061' .. '\\u007a' | '\\u00c0' .. '\\u00d6' | '\\u00d8' .. '\\u00f6' | '\\u00f8' .. '\\u00ff' | '\\u0100' .. '\\u1fff' | '\\u3040' .. '\\u318f' | '\\u3300' .. '\\u337f' | '\\u3400' .. '\\u3d2d' | '\\u4e00' .. '\\u9fff' | '\\uf900' .. '\\ufaff' )
            // JavaL.g:
            {
    ...
    public final void mJavaIDDigit() throws RecognitionException {
        try {
            // JavaL.g:96:5: ( '\\u0030' .. '\\u0039' | '\\u0660' .. '\\u0669' | '\\u06f0' .. '\\u06f9' | '\\u0966' .. '\\u096f' | '\\u09e6' .. '\\u09ef' | '\\u0a66' .. '\\u0a6f' | '\\u0ae6' .. '\\u0aef' | '\\u0b66' .. '\\u0b6f' | '\\u0be7' .. '\\u0bef' | '\\u0c66' .. '\\u0c6f' | '\\u0ce6' .. '\\u0cef' | '\\u0d66' .. '\\u0d6f' | '\\u0e50' .. '\\u0e59' | '\\u0ed0' .. '\\u0ed9' | '\\u1040' .. '\\u1049' )
            // JavaL.g:
            {
    ...
    public final void mCOMMENT() throws RecognitionException {
        try {
            int _type = COMMENT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // JavaL.g:117:5: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // JavaL.g:117:9: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // JavaL.g:117:14: ( options {greedy=false; } : . )*
            loop26:
            do {
                int alt26=2;
    ...
    public void mTokens() throws RecognitionException {
        // JavaL.g:1:8: ( HexLiteral | DecimalLiteral | OctalLiteral | FloatingPointLiteral | CharacterLiteral | StringLiteral | ENUM | ASSERT | Identifier | WS | COMMENT | LINE_COMMENT )
        int alt29=12;
