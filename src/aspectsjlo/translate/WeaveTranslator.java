...
import aspectsjlo.translate.weaver.JLoWeaveTransformer;
...
public class WeaveTranslator {

	public WeaveTranslator(AspectsJLo source, AspectsJLo target) {
		_sourceLanguage = source;
		_targetLanguage = target;
		_translator = new JLoWeaveTransformer();
	}
